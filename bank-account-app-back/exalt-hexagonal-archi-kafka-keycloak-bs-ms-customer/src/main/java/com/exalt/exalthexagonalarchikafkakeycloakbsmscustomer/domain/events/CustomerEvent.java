...
public class CustomerEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1474199780323925308L;
  ...
  private com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer customer;
   ...
   */
  public CustomerEvent(java.lang.String message, java.lang.String status, com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer customer) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: customer = (com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer getCustomer() {
    return customer;
  }
   ...
   * @param value the value to set.
   */
  public void setCustomer(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer value) {
    this.customer = value;
  }
   ...
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder newBuilder() {
    return new com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder();
  }
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder newBuilder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder other) {
    if (other == null) {
      return new com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder();
    } else {
      return new com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder(other);
    }
  }
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder newBuilder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent other) {
    if (other == null) {
      return new com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder();
    } else {
      return new com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerEvent>
    ...
    private java.lang.String status;
    private com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer customer;
    private com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.Builder customerBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder other) {
      super(other);
      ...
      if (other.hasCustomerBuilder()) {
        this.customerBuilder = com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.newBuilder(other.getCustomerBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder setCustomer(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer value) {
     ...
     * @return This builder.
     */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.Builder getCustomerBuilder() {
      if (customerBuilder == null) {
        if (hasCustomer()) {
          setCustomerBuilder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.newBuilder(customer));
        } else {
          setCustomerBuilder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.newBuilder());
        }
      }
    ...
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder setCustomerBuilder(com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer.Builder value) {
      clearCustomer();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.CustomerEvent.Builder clearCustomer() {
      customer = null;
    ...
    public CustomerEvent build() {
      try {
        ...
        if (customerBuilder != null) {
          ...
          record.customer = fieldSetFlags()[2] ? this.customer : (com.exalt.exalthexagonalarchikafkakeycloakbsmscustomer.domain.events.Customer) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
