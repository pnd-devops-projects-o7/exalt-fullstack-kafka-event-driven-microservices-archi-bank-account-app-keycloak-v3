 ...
 */
package com.exalt.exalthexagonalarchikafkakeycloakbsmsnotificationservice.events;
...
public class CustomerEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CustomerEvent(java.lang.String message, java.lang.String status, Customer customer) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: customer = (Customer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static CustomerEvent.Builder newBuilder(CustomerEvent.Builder other) {
    if (other == null) {
      return new CustomerEvent.Builder();
    } else {
   ...
   * @return A new CustomerEvent RecordBuilder
   */
  public static CustomerEvent.Builder newBuilder(CustomerEvent other) {
    if (other == null) {
      return new CustomerEvent.Builder();
    } else {
      return new CustomerEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerEvent>
    ...
    private Builder(CustomerEvent.Builder other) {
      ...
      if (other.hasCustomerBuilder()) {
        this.customerBuilder = Customer.newBuilder(other.getCustomerBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public CustomerEvent.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CustomerEvent.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CustomerEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CustomerEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CustomerEvent.Builder setCustomer(Customer value) {
    ...
    public Customer.Builder getCustomerBuilder() {
      if (customerBuilder == null) {
        if (hasCustomer()) {
          setCustomerBuilder(Customer.newBuilder(customer));
        } else {
          setCustomerBuilder(Customer.newBuilder());
        }
      }
    ...
    public CustomerEvent.Builder setCustomerBuilder(Customer.Builder value) {
      clearCustomer();
    ...
    public CustomerEvent build() {
      try {
        ...
        if (customerBuilder != null) {
          ...
          record.customer = fieldSetFlags()[2] ? this.customer : (Customer) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
