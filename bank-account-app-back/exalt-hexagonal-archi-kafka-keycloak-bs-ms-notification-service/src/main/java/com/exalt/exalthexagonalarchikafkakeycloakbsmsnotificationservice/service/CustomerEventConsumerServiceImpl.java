package com.exalt.exalthexagonalarchikafkakeycloakbsmsnotificationservice.service;

import com.exalt.exalthexagonalarchikafkakeycloakbsmsnotificationservice.domain.events.CustomerEvent;
...
@Service
public class CustomerEventConsumerServiceImpl {
    private final Logger logger = Logger.getLogger(this.getClass().getName());
    private final JavaMailSender javaMailSender;

    public CustomerEventConsumerServiceImpl(JavaMailSender javaMailSender) {
        this.javaMailSender = javaMailSender;
    }
    @KafkaListener(topicPartitions = @TopicPartition(topic = "t_customer",
            partitionOffsets = {
